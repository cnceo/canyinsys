...
<ul class="nav nav-tabs">
    ...
    <li <?php  if($operation == 'post') { ?>class="active"<?php  } ?>><a
        href="<?php  echo $this->createWebUrl('stores2', array('op' => 'post'))?>">添加门店</a></li>
    <?php  } ?>
    <?php  } ?>
    <?php  if($operation == 'setting') { ?>
...
<div class="main">
    ...
    <?php  } ?>
    <div class="alert alert-info">
        <i class="fa fa-info-circle"></i> 商家登陆地址:<a href="<?php  echo $_W['siteroot'];?>addons/weisrc_dish/admin" target="_blank"><?php  echo $_W['siteroot'];?>addons/weisrc_dish/admin</a>
    </div>
            ...
            <form action="./index.php" method="post" class="navbar-form navbar-left" enctype="multipart/form-data">
                ...
                <span class="input-group">
			        ...
			        <span class="input-group-btn">
                        ...
                        <a class="btn btn-primary ms_mb" href="<?php  echo $_W['siteroot'];?>addons/weisrc_dish/example/example_store.xls">下载导入模板</a>
                    </span>
            ...
            <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
                <table class="table table-hover table-bordered">
                    ...
                    <tr>
                        ...
                        <td><a href="<?php  echo $this->createWebUrl('stores2', array('id' => $item['id'], 'storeid' =>  $item['id'], 'op' => 'post'))?>" title="管理">
                        ...
                        <td style="max-width:70px;text-align: right;">
                        	...
                        	<a class="btn btn-danger btn-sm" href="<?php  echo $this->createWebUrl('stores2', array('id' => $item['id'], 'storeid' =>  $item['id'], 'op' => 'post'))?>" data-toggle="tooltip" title="门店管理" data-content="商品管理,订单管理" ><i class="fa fa-cog fa-spin"> </i>管理</a>
