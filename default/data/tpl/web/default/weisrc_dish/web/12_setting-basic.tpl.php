<?php defined('IN_IA') or exit('Access Denied');?><div class="tab-pane  active" id="tab_basic">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">是否开启操作密码</label>
                <div class="col-sm-9">
            ...
            <?php  } ?>
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">导航是否显示首页</label>
                <div class="col-sm-9">
            ...
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">下单地址默认关联当前地图位置</label>
                <div class="col-sm-9">
                    <label for="is_auto_address1" class="radio-inline"><input type="radio" name="is_auto_address" value="1" id="is_auto_address1" <?php  if($setting['is_auto_address']==1) { ?>checked<?php  } ?> /> 开启</label>
                    <label for="is_auto_address2" class="radio-inline"><input type="radio" name="is_auto_address" value="0" id="is_auto_address2"  <?php  if($setting['is_auto_address']==0 || empty($setting)) { ?>checked<?php  } ?> /> 关闭</label>
                </div>
            </div>
            <div class="form-group">
