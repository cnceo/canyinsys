...
<style type="text/css">
    ...
    ul.order-process li {float : left; width : <?php  if($item['dining_mode']==2) { ?>25%<?php  } else { ?>33%<?php  } ?>; text-align : center;
    overflow : hidden;}
...
<div class="main">
    <div class="panel panel-default">
        <div class="panel-body">
            <a class="btn btn-warning" href="<?php  echo $this->createWebUrl('allorder', array('op' => 'display'))?>">返回订单管理
            </a>
        </div>
    </div>
            ...
            <div class="panel-body table-responsive collapse in" id="freight-template-item-0" style="padding:0;  overflow-y:hidden;">
                <div style="margin-top:20px;">
                    <ul class="order-process clearfix">
                        ...
                        <li <?php  if($item['delivery_status'] == 1 || $item['delivery_status'] == 2) { ?>class="active"<?php  } ?>>
                        <p class="order-process-state">
                            <?php  if($item['delivery_status'] == 1) { ?>配送中<?php  } ?>
                            <?php  if($item['delivery_status'] == 2) { ?>已配送<?php  } ?></p>
                        <p class="bar"><i class="square finish">√</i></p>
                        <p class="order-process-time">
                        </p>
                        </li>
                    ...
                    <div class="panel-body clearfix">
                        <form class="form-horizontal form" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="form-group clearfix js-fee">
                                    <label class="col-xs-2 col-sm-2 control-label">改价：</label>
    ...
    <form class="form-horizontal form" action="" method="post" enctype="multipart/form-data">
        ...
        <div style="width:400px;position:absolute;top:40%;left:30%;z-index:2;display:none;" class="table_display">
            <div class="panel panel-default">
    ...
    <form class="form-horizontal form" action="" method="post" enctype="multipart/form-data">
        ...
        <div style="width:400px;position:absolute;top:40%;left:30%;z-index:2;display:none;" class="discount_display">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-md-8">
                        <input class="form-control discount_input" name="discount_rebate" placeholder="请输入折扣" title="菜品有折扣则进行折扣计算"></div>
            ...
            <div class="modal-content">
                ...
                <form role="form" action="" method="post" class="form form-horizontal">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover text-center" id="addShow">
                        </table>
                    </div>
    ...
    <!--<div class='input-group'><span class='input-group-addon'>-</span><input type='text' class='form-control stat-num' value='3'><span class='input-group-addon'>+</span></div>-->
    <script>
    ...
    <form class="form-horizontal form" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="table-responsive panel-body">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php  if($item['ispay']==0) { ?>
                            <a class="btn btn-danger span1" href="<?php  echo $this->createWebUrl('retreat', array('orderid' => $id, 'goodsid' => $row['goodsid'],'storeid' => $storeid))?>"  onclick="return confirm('确认退菜吗？'); return false;" title="退菜">退菜</a>
                            <?php  } ?>
                        </td>
                    </tr>
                    <?php  } } ?>
        ...
        <div class="form-group col-sm-12" style="margin-bottom: 15px;">
            ...
            <a class="btn btn-success span2" href="#"  onclick="alert('请先支付订单，再完成订单');
                    return false;" title="完成">完成订单</a><?php  } else { ?><a class="btn btn-success span2" href="<?php  echo $this->createWebUrl('allorder', array('op' => 'detail', 'id' => $item['id'], 'storeid' => $storeid, 'finish' => 'finish'))?>"  onclick="return confirm('确认设置该订单为完成支付吗？'); return false;" title="完成">完成订单</a>
            <?php  } ?>
            <?php  } ?>
            <?php  if($item['status'] != -1) { ?>
