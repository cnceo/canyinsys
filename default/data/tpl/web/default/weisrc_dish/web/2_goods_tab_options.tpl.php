        ...
        <div class="panel-body">
            <!--<div class="form-group">-->
                ...
                <!--<div class="col-sm-9 col-xs-12">-->
                    ...
                    <!--<br>-->
                    <!--<div id="options" <?php  if($item['is_options']==1) { ?>style="display:block"<?php  } ?>>-->
                    <!--<div class="tpl">-->
                        ...
                        <!--<div class="input-group">-->
                            ...
                            <!--<input type="text" name="options[name][]" value="<?php  echo $row['name'];?>" class="form-control"-->
                                   <!--placeholder="规格名称">-->
                            <!--<span class="input-group-addon">价格</span>-->
                            <!--<input type="text" name="options[price][]" value="<?php  echo $row['price'];?>" class="form-control"-->
                                   <!--placeholder="价格">-->
                            <!--<span class="input-group-addon">库存</span>-->
                            <!--<input type="text" name="options[total][]" value="<?php  echo $row['total'];?>" class="form-control"-->
                                   <!--placeholder="库存">-->
