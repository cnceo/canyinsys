...
<div class="main">
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li>
            <a href="<?php  echo $this->createWebUrl('goods', array('op' => 'post', 'storeid' => $storeid))?>">添加商品</a>
        </li>
        <li>
            ...
            <form action="" method="post" class="navbar-form navbar-left" enctype="multipart/form-data">
                ...
                <span class="input-group">
			        ...
			        <span class="input-group-btn">
                        ...
                        <a class="btn btn-primary ms_mb" href="<?php  echo $_W['siteroot'];?>addons/weisrc_dish/example/example_goods3.xls">下载导入模板
                        </a>
                    </span>
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align:right;">
						<a class="btn btn-default btn-sm" href="<?php  echo $this->createWebUrl('goods', array('id' => $item['id'], 'op' => 'post', 'storeid' => $storeid))?>" title="编辑">改</a>&nbsp;&nbsp;<a class="btn btn-default btn-sm" href="<?php  echo $this->createWebUrl('goods', array('id' => $item['id'], 'op' => 'delete', 'storeid' => $storeid))?>" onclick="return confirm('此操作不可恢复，确认删除？');return false;" title="删除">删</a>
					</td>
				</tr>
				<?php  } } ?>
			</tbody>
