...
<!--<link href="<?php  echo $_W['siteroot'];?>addons/weisrc_dish/public/web/css/bootstrap.min14ed.css?v=3.3.6" rel="stylesheet">-->
<!--<link href="<?php  echo $_W['siteroot'];?>addons/weisrc_dish/public/web/css/font-awesome.min93e3.css?v=4.4.0" rel="stylesheet">-->
<!--<link href="<?php  echo $_W['siteroot'];?>addons/weisrc_dish/public/web/css/animate.min.css" rel="stylesheet">-->
<!--<link href="<?php  echo $_W['siteroot'];?>addons/weisrc_dish/public/web/css/style.min862f.css?v=4.1.0" rel="stylesheet">-->
<style>
...
<div class="navbar navbar-inverse navbar-static-top" role="navigation" style="position:static;border-top: 4px solid #20a0ff;background-color: #fff;border-bottom: 0px solid #d9dadc;">
	...
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav">
			...
			<?php  if(!empty($_W['isfounder']) || empty($_W['setting']['permurls']['sections']) || in_array('ext', $_W['setting']['permurls']['sections'])) { ?><li><a href="<?php  echo url('home/welcome/ext');?>"><i class="fa fa-cubes"></i>扩展功能</a></li><?php  } ?>
			<?php  } ?>
			<?php  if(!empty($_GPC['storeid'])) { ?>
	<li <?php  if($_GPC['do']=='start') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('start', array('op' => 'display', 'storeid' => $storeid))?>"><i class="fa fa-home"></i>首页</a></li> 
			...
			<li <?php  if($_GPC['do']=='coreuser') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('coreuser', array('op' => 'display', 'storeid' => $storeid))?>"><i class="fa fa-user"></i>员工</a></li>
			<?php  } ?>
		</ul>
		<?php  } ?>
