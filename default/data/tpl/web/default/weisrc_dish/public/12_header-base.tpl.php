...
<head>
	...
	<title><?php  if(isset($title)) $_W['page']['title'] = $title?><?php  if(!empty($_W['page']['title'])) { ?><?php  echo $_W['page']['title'];?><?php  } ?><?php  if(empty($_W['page']['copyright']['sitename'])) { ?><?php  if(IMS_FAMILY != 'x') { ?>智慧餐饮系统<?php  } ?><?php  } else { ?> - <?php  echo $_W['page']['copyright']['sitename'];?><?php  } ?></title>
	<meta name="keywords" content="智慧餐饮系统" />
	<meta name="description" content="智慧餐饮系统" />
	...
	<!--/addons/weisrc_dish/template/css/bootstrap.min.css-->
	<!--/addons/weisrc_dish/template/css/common.css-->
