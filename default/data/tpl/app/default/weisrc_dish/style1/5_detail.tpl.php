...
<div id="wrap1">
    ...
    <!--<div id="menu-tabs-container">-->
        <!--<div class="j-menu-tabs menu-tabs">-->
            <!--<a href="javascript:void(0);" class="selected tab3" style="width:34%">-->
                <!--<span>商家</span>-->
            <!--</a>-->
...
<!--tab3开始-->
<div class="main-tab3" style="margin-top:136px;overflow: scroll;height: 100%;overflow-y:scroll;-webkit-overflow-scrolling:touch;">
    <?php  if(!empty($item['thumbs'])) { ?>
    <!--<div class="swiper-container">-->
        <!--<div class="swiper-wrapper">-->
            <?php  if(is_array($item['thumbs'])) { foreach($item['thumbs'] as $slide) { ?>
            <!--<div class="swiper-slide">-->
                <!--<a href="<?php  if(empty($slide['url'])) { ?>#<?php  } else { ?><?php  echo $slide['url'];?><?php  } ?>">-->
    ...
    <div class="detail-region" style="">
        <div class="detail-content">
            <div class="detail-phone">
                <i class="rest-ico"></i>
                <p>电话： <?php  echo $item['tel'];?> <a href="tel:<?php  echo $item['tel'];?>"><span class="mt-delivery">拨打</span></a>
            ...
            <div class="detail-address">
                ...
                <p><?php  echo $item['address'];?> <a href="http://api.map.baidu.com/marker?location=<?php  echo $item['lat'];?>,<?php  echo $item['lng'];?>&title=<?php  echo $item['title'];?>&content=<?php  echo $item['address'];?>&output=html&src=wzj|wzj" ><span
    ...
    <div class="detail-region" style="">
        <div class="detail-favor">
            ...
            <!--<div class="discountitem">-->
                <!--<i class="list-icon">-->
                    <!--<img class="fav-icon-img i-x15" src="<?php  echo $this->cur_mobile_path?>/image/fan.png">-->
                <!--</i>-->
                <!--<p class="list-contect">满20返5元现金</p>-->
            <!--</div>-->
    ...
    <div class="detail-qualification" style="">
        <div class="qualification"><a href="#">查看店铺</a></div>
    </div>
    <div class="detail-photo">
        <div class="photo-header">店铺信息</div>
        <div class="bnrs-wrap">
            <div id="bnrs" class="bnrs" style="width:100%; padding:10px;">
...
<script>
    $(function() {
        ...
        $('.qualification').click(function(){
            ...
            $('.main-tab3').css({"margin-top":"146px"})
        });
