...
//                                if (confirm('检测到您的地址为,是否填入地址栏中：\r\n' + address)) {}
        ...
        <div class="section no-bottom-border">
            ...
            <div class="list-item">合计：<span class="red ng-binding"><?php  echo $order['totalnum'];?>份</span>，<strong
                ...
                <span class="ng-scope">(<?php  echo $coupon_info;?>)</span>
                <?php  } ?>
                <?php  if($order['dining_mode']==1 && $order['tea_money'] != '0.00') { ?>
                <span class="ng-scope">(<?php  echo $order['tea_money'];?>元茶位费)</span>
                <?php  } ?>
                <?php  if($order['dining_mode']==1 && $order['service_money'] != '0.00') { ?>
                <span class="ng-scope">(<?php  echo $order['service_money'];?>元服务费)</span>
                <?php  } ?>
                <?php  if($order['dining_mode']==2) { ?>
                <?php  if($order['dispatchprice'] != '0.00') { ?>
                <span class="ng-scope">(<?php  echo $order['dispatchprice'];?>元配送费)</span>
                <?php  } else { ?>
                <span class="ng-scope">(免配送费)</span>
                <?php  } ?>
                <?php  if($order['packvalue'] > 0) { ?>
                <span class="ng-scope">(<?php  echo $order['packvalue'];?>元打包费)</span>
                <?php  } ?>
                <?php  } ?>
        ...
        <div class="order-info-section">
            ...
            <div class="item ng-scope">
                ...
                <span class="value ng-binding"> <?php  if($order['paytype']==0) { ?>未选择<?php  } else if($order['paytype']==1) { ?>余额支付<?php  } else if($order['paytype']==2) { ?>微信支付<?php  } else if($order['paytype']==3) { ?>现金支付<?php  } else if($order['paytype']==4) { ?>支付宝支付<?php  } ?></span>
            </div>
            <div class="item ng-scope">
