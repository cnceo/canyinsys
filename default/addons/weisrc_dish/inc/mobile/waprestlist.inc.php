...
$authurl = $_W['siteroot'] . 'app/' . $this->createMobileUrl($method, array('typeid' => $typeid), true) . '&authkey=1';
$url = $_W['siteroot'] . 'app/' . $this->createMobileUrl($method, array('typeid' => $typeid), true);
...
$share_url = $_W['siteroot'] . 'app/' . $this->createMobileUrl('waprestlist', array(), true);
