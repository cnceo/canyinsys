...
$authurl = $_W['siteroot'] . 'app/' . $this->createMobileUrl($method, array('orderid' => $id), true) . '&authkey=1';
$url = $_W['siteroot'] . 'app/' . $this->createMobileUrl($method, array('orderid' => $id), true);
